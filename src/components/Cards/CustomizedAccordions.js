...
const makeSeverityStyles=(status)=>{
  if (status==="Hard"){
    return{
      background:"#FFC2AC",
      color:'#FF4039'
          ...
          {rows.map((row, index) => (
            <React.Fragment key={index}>
              <TableRow>
                ...
                <TableCell>
                  <span className="severity_status" style={makeSeverityStyles(row.severity)} >{row.severity}</span>
                </TableCell>
                ...
                <TableCell colSpan={3}>
                  ...
                  >
                    ...
                    <MuiAccordionDetails>
                      ...
                      <Button variant="contained" color="primary">Assign Alert</Button>
                    </MuiAccordionDetails>
                  </MuiAccordion>
                </TableCell>
              </TableRow>
