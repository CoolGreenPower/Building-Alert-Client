...
import { deviceDetailsFields } from "../constants"
    ...
    <Layout>
        <div className="flex flex-row w-full">
            <div className="fixed left-0 h-full border-r-2 border-gray-500 bg-background p-4 z-20 w-[10rem]">
                <div className="flex flex-col items-start">
                    <div className="border-b-2 border-gray-500 pb-2">
                        <h1 className="text-lg">Device Details</h1>
            ...
            <div className="pl-[11rem] pt-5 pr-5 flex flex-1 flex-col">
                <h1 className="text-4xl mb-5 w-full">{ device.device || "Device" }</h1>
                { (activeSection == "details" && Object.keys(device).length > 0) &&
                    <InfoListing showHidden={showKeys} data={device} formFields={deviceDetailsFields}/>
                }
