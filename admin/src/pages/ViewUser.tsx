    ...
    <Layout>
        <div className="flex flex-row w-full">
            ...
            <div className="pl-[11rem] pt-5 pr-5 flex flex-1 flex-col">
                <h1 className="text-4xl mb-5 w-full">{ user.name }</h1>
                { (activeSection == "details" && Object.keys(user).length > 0) && 
                    <InfoListing showHidden={showKeys} data={user} formFields={userDetailsFields}/>
                }
